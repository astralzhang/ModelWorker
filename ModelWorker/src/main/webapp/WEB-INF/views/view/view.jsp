...
<head>
    ...
    <script type="text/javascript" src="${rc.contextPath}/js/view/jquery.media.js"></script>
    <script type="text/javascript" src="${rc.contextPath}/js/view/mydetail.js"></script>
    <script type="text/javascript">
    
	$(function() {
		var headScript = ${viewBean.headScript};
		$("#headerTable").mydetail(headScript, ${viewBean.detailScript}, "${rc.contextPath}", "${viewBean.no}", "${id}", ${data}, ${attachment}, false);
...
<%--           	</hq:auth> --%>
<%--           	<hq:auth act="CancelSubmit" view="${viewBean.no }"> --%>
<!--        			<button class="btn_header" id="btn_cancel_submit" type="button">撤销</button> -->
<%--        		</hq:auth> --%>
<%--        		<hq:auth act="CancelAudit" view="${viewBean.no }"> --%>
<!--        			<button class="btn_header" id="btn_cancel_audit" type="button">撤审</button> -->
<%--        		</hq:auth> --%>
<!--           	</div> -->
