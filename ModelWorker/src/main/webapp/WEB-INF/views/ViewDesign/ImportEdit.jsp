...
<head>
	...
	<script type="text/javascript" src="${rc.contextPath}/js/mytable/myimport.js"></script>
    <title></title>
	...
	$(document).ready(function() {
		...
		var myimport = $("#form1").myimport(${data.script});
		$("#btn_save").click(function () {
			...
			data.no = $("#no").val();
			data.name = $("#name").val();
			data.model = $("#importModel").val();
			data.script = JSON.stringify(myimport.config);
			alert(JSON.stringify(data));
			MessageBox.processStart();
			$.ajax({
				url:"${rc.contextPath}/ImportDesign/save",
				type:"post",
				dataType:"json",
		...
		$("#btn-back").click(function() {
			location.href = "${rc.contextPath}/ImportDesign/list";
		});
	});	
</script>
</head>
<body>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <ol class="breadcrumb">
                <li><a href="${rc.contextPath}/ImportDesign/list"><i class="fa fa-folder"></i>画面设计</a></li>
                <li class="active">导入设定</li>
            </ol>
            <div class="btn_box">
          	<div class="search">
          	...
          	<div class="btn-group">
          	<a class="btn_header" id="btn-file" href="#">文件类型</a>
          		<a class="btn_header" id="btn-excel" href="#">Excel设定</a>
          		<a class="btn_header" id="btn-text" href="#">文本文件设定</a>
          		...
          		<a class="btn_header" id="btn-SpaceRow" href="#">空行处理</a>
            ...
            <div class="box box-info product-info">
                ...
                <div class="box-body">
                    ...
                    <table class="table table-bordered">
                        <tr>
                            <td>导入设定编号</td>
                            <td><input id="no" type="text" name="no" maxlength="100" value="${data.no}" class="form-control input-sm fl w15" placeholder="导入设定编号"></td>
                            <td>导入设定名称</td>
                            <td><input type="text" id="name" name="name"  value="${data.name}" class="form-control input-sm fl w15" placeholder="导入设定名称"></td>
                            <td>导入模式</td>
                            <td>
                            	<select id="importModel" name="importModel"  class="form-control2" required>
                    ...
                    <table id="dbMapping" class="table table-bordered" id="viewField">
                    	<thead>
                    		<tr>
                    			...
                    			<th>映射类型</th>
                    			<th>映射字段</th>
                    			<th>是否数据重复<br>check字段</th>
                    			<th>SQL或存储过程<br>目标数据库</th>
                    		</tr>
                        </thead>
                        <tbody>
                        </tbody>
        ...
        <div class="modal fade" id="myImportModal" aria-labelledby="myImportModal">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myImportModalLabel">条件设定</h4>
                    </div>
                    <div class="modal-body">
                        <div class="row" style="margin-left: 0px;">
                            <form id="myImportModalForm" role="form1" action="${rc.contextPath}/viewDesign/edit" method="post">
                        ...
                        <div id="myImportDetail" style="margin-top:20px;max-height: 350px;overflow-y: auto;overflow-x: auto;">
                            <table class="table table-bordered table-condensed">
                            	<thead>
	                                <tr>
	                                    <th>选择</th>
