...
$.extend(true,myflow.config.props.props,{
	...
	key : {name:'key', label:'标识', value:'11', editor:function(){return new myflow.editors.inputEditor();}},
	desc : {name:'desc', label:'描述', value:'22', editor:function(){return new myflow.editors.inputEditor();}}
});
*/
$.extend(true,myflow.config.tools.states,{
	start : {
		...
		props : {
			id: {name:'id', label: 'id', value:'', editor:function(){return new myflow.editors.idEditor();}, value:''},
	...
	condition : {showType: 'image',type : 'condition',
		name : {text:'<<fork>>'},
		text : {text:'条件'},
		...
		props : {
			...
			condition: {name:'condition', label : '条件', value:'', editor: function(){return new myflow.editors.conditionEditor();}}
		}},
	...
	task : {showType: 'text',type : 'task',
		...
		props : {
			id: {name:'id', label: 'id', value:'', editor:function(){return new myflow.editors.idEditor();}, value:''},
			text: {name:'text', label: '显示', value:'', editor: function(){return new myflow.editors.textEditor();}, value:'审核'},
			desc: {name:'desc', label : '描述', value:'', editor: function(){return new myflow.editors.inputEditor();}},
			processor: {name:'processor', label: '用户', value:'', editor: function(){return new myflow.editors.userEditor();}},
			sql:{name:'sql', label:'审核处理',value:'',editor:function() {return new myflow.editors.sqlEditor();}}
		}}
});
})(jQuery);